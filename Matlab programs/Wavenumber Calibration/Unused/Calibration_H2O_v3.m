...
function [ output1 ] = Calibration_H2O_v3(input1, input2)
...
% figure;plot(data_wavenumber_region(max_indexes),data_absorbance_region(max_indexes),'*k');
% 
...
figure;plot(calibrated_wavenumber,calibrated_wavenumber_peaks)
end

%%Interpolation
wavenumber_interp = [1150 : 0.05 : 1263];
